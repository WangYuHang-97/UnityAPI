...
namespace BayatGames.SaveGameFree
{
    ...
    public enum SaveGamePath
    {
        ...
        /// <summary>
        /// The data path. $"E:\\MaoXianYuJingYing\\Unity\\Assets\\Data\\LevelData"
        /// </summary>
        DataPath
    ...
    public static class SaveGame
    {
        ...
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static void Save<T>(string identifier, T obj, bool encode, string encodePassword, SaveGamePath savePath)
        {
            Save<T>(identifier, obj, encode, encodePassword, Serializer, Encoder, DefaultEncoding, savePath);
        }
        ...
        /// <param name="encode">If set to <c>true</c> encode.</param>
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static void Save<T>(string identifier, T obj, bool encode, SaveGamePath savePath)
        {
            Save<T>(identifier, obj, encode, EncodePassword, Serializer, Encoder, DefaultEncoding, savePath);
        }
        ...
        /// <param name="savePath">Save path.</param>
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static T Load<T>(string identifier, T defaultValue, string password, SaveGamePath savePath)
        {
            return Load<T>(identifier, defaultValue, true, password, Serializer, Encoder, DefaultEncoding, savePath);
        }
        ...
        public static void DeleteAll(SaveGamePath path)
        {
            ...
            switch (path)
            {
                case SaveGamePath.PersistentDataPath:
                    ...
                    break;
                case SaveGamePath.DataPath:
                    dirPath = $"E:\\MaoXianYuJingYing\\Unity\\Assets\\Data\\LevelData";
                    break;
            }
#if !UNITY_SAMSUNGTV && !UNITY_TVOS && !UNITY_WEBGL
            if (IOSupported())
